...
% Add gbvs to path
gbvsPath = [pathroot filesep 'dvs_release_EXPERIMENT/dvs_release/gbvs'];
%gbvsPath
addpath(genpath(gbvsPath), '-begin');


% Add textSaliency to path
tsPath = [pathroot filesep 'dvs_release_EXPERIMENT/dvs_release/textSaliency'];
%tsPath
...
dvsPath = [pathroot filesep 'dvs_release_EXPERIMENT/dvs_release'];
%dvsPath
...
pathroot = gbvsPath;
save -mat dvs_release_EXPERIMENT/dvs_release/gbvs/util/mypath.mat pathroot
